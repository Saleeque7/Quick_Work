...
export default function Hire() {
  ...
  const initialAddressInfo =
    JSON.parse(localStorage.getItem("addressInfo")) || null;
  const [adressinfo, setAddressInfo] = useState(initialAddressInfo);
        ...
        handler: async function (response) {
          ...
          if (verifyResult.status === 200) {
            ...
            if (res.status === 200) {
              ...
              setTimeout(() => {
                navigate(`/client/viewContract/${contractId}`)
              }, 2000);
            } else {
            ...
            <div className="mx-4">
              <div className="p-5 border rounded-lg shadow-lg w-full">
                ...
                <div className="py-4">
                  <div className="flex flex-col">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex justify-between mb-2">
                        <span>Contract Initiation Fee (20%)</span>
                        <span className="flex items-center">
                          <MdCurrencyRupee />
                ...
                <div className="flex flex-col items-end my-5">
                  <div className="flex items-center mb-4">
                    <button
                      className="bg-teal-600 text-white px-4 py-2 border border-gray-400 rounded hover:bg-teal-900 flex items-center"
