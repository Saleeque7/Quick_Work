...
export default function EditableProfile({ userData, setUserData }) {
  ...
  const handleSkillsSave = async () => {
    if (skills.length === 0) {
      ...
      if (skills.includes("")) {
        setSkillsError("Please fill in all skill fields before adding a new one.");
        return;
      }
  ...
  return (
    <>
      <div className="flex justify-between w-full mb-5">
        <div className="flex space-x-4">
          ...
          <div className="relative group">
            ...
            <h2 className="font-semibold text-xl text-teal-700 mt-1 pr-6 relative group">
              {userData?.jobTitle || ""}
              <FaEdit
            ...
            <h2 className="font-semibold text-sm text-teal-700 pr-6 relative group">
      ...
      <div className="flex mt-10 relative group">
      ...
      <Modal isOpen={isSkillsModalOpen} onClose={closeSkillsModal}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            {skillsError && (
          <p className="text-red-500 mt-2">{skillsError}</p>
        )}
          </ModalBody>
          <ModalFooter>
