...
export default (dependecies)=>{
    const {loadUserHome ,userAuthController,verifyotpController ,resendOtpController , addProfileController , addProfileSecController , experienceController , isUserprofileController } = userController(dependecies) 
