...
export default (dependencies) => {
    const { adminAUthController, registerController, getUserDataController, getClientDataController, blockuserController, unblockuserController ,blockclientController , unblockclilentController ,searchcontroller} = adminController(dependencies)
